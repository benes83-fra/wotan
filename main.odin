...
main :: proc() {
	...
	// test.hrp_test(context.temp_allocator)
	// test.hmm_regime_test(context.temp_allocator)
	// test.optimal_execution_test(context.temp_allocator)
	test.orchestrator_test(context.temp_allocator)
	...
	test.mamba_test(context.temp_allocator)
	test.mamba_learning_test(context.temp_allocator)
	...
	// test.ir_derivatives_2f_test(context.temp_allocator)
	...
	// test.american_options_test(context.temp_allocator)
	// test.trinomial_tree_test(context.temp_allocator)
	...
	// test.implied_pd_and_fbm_test(context.temp_allocator)
	// test.rough_volatility_test(context.temp_allocator)
